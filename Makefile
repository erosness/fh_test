...
package-deb-doc-1:
	...
	cp thingsplex_service_template package/debian1/opt/thingsplex/thingsplex_service_template
	cp VERSION package/debian1/opt/thingsplex/thingsplex_service_template
...
package-deb-doc-2:
	...
	cp thingsplex_service_template package/debian2/usr/bin/thingsplex_service_template
	cp VERSION package/debian2/opt/thingsplex/thingsplex_service_template
	docker run --rm -v ${working_dir}:/build -w /build --name debuild debian dpkg-deb --build package/debian
	@echo "Done"
